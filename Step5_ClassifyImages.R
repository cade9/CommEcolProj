...
write.csv(test.df, "./Data/L8_2014-2015_test/L8_test_40_Apr29.csv")
write.csv(train.df, "./Data/L8_2014-2015_test/L8_train_60_Apr29.csv")
writeOGR(testData , dsn= "./Data/L8_2014-2015_test","testData_40_Apr29", driver= "ESRI Shapefile")
writeOGR(trainData, dsn= "./Data/L8_2014-2015_test","trainData_60_Apr29", driver= "ESRI Shapefile")
...
mod_RF
# save model
saveRDS(mod_RF, "./Data/L8_2014-2015_test/mod_RF_60_Apr29.rds")
...
outdir = "./Output/Classified_Apr29"
...
for (i in 2:length(my.raster)) {
	...
	r.date
	rastername2=paste0("L8_",r.date, "_classified_60_Apr29")
	## write raster 
